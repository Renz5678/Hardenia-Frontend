    ...
    const FLOWER_GROWTH_TEMPLATES = {
        sunflower: { maxHeight: 200, growthRate: 2.5 },      // Fast-growing, can reach 2m
        anthurium: { maxHeight: 45, growthRate: 0.5 },       // Slow-growing houseplant
        hibiscus: { maxHeight: 250, growthRate: 1.8 },       // Moderate to fast, large shrub
        kalachuchi: { maxHeight: 600, growthRate: 1.2 },     // Slow to moderate, can become tree
        zinnias: { maxHeight: 90, growthRate: 2.0 },         // Fast-growing annual
        cosmos: { maxHeight: 120, growthRate: 2.2 },         // Fast-growing annual
        marigold: { maxHeight: 60, growthRate: 1.5 },        // Moderate-growing annual
        sampaguita: { maxHeight: 180, growthRate: 1.0 },     // Moderate-growing shrub
        tulips: { maxHeight: 50, growthRate: 1.3 }           // Moderate-growing bulb
    };
